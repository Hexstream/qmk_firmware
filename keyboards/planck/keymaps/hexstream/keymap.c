...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_planck_grid(DYN_REC_STOP,KC_F11,KC_F12,KC_F13,KC_PGUP,KC_F15,KC_END,KC_F17,KC_F18,KC_F19,KC_F20,LSFT(KC_2),DYN_REC_START1,RALT(KC_Q),KC_NONUS_HASH,RALT(KC_MINUS),LSFT(KC_9),DYN_MACRO_PLAY1,DYN_MACRO_PLAY2,LSFT(KC_0),RALT(KC_EQUAL),LSFT(KC_NONUS_HASH),RALT(KC_NONUS_HASH),DYN_MACRO_PLAY2,DYN_REC_START2,LCTL(LGUI(KC_1)),LCTL(LGUI(KC_2)),LCTL(LGUI(KC_3)),LCTL(LGUI(KC_4)),LCTL(LGUI(KC_0)),KC_HOME,KC_F14,KC_EQUAL,KC_PGDOWN,LSFT(KC_NONUS_HASH),KC_KP_ENTER,LGUI(KC_PGDOWN),LGUI(KC_PGUP),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_LEFT,KC_NO,KC_TRANSPARENT,KC_TRANSPARENT,LGUI(KC_D),LSFT(KC_RBRACKET),KC_TRANSPARENT),

  [_RAISE] = LAYOUT_planck_grid(KC_ESCAPE,KC_F1,KC_F2,KC_F3,KC_UP,KC_F5,KC_RIGHT,KC_F7,KC_F8,KC_F9,KC_F10,KC_LBRACKET,RALT(KC_GRAVE),KC_1,KC_2,KC_3,KC_4,KC_5,KC_6,KC_7,KC_8,KC_9,KC_0,DYN_MACRO_PLAY1,RALT(KC_2),LGUI(KC_1),LGUI(KC_2),LGUI(KC_3),LGUI(KC_4),KC_F6,KC_LEFT,RALT(KC_Z),KC_MINUS,KC_DOWN,KC_NONUS_HASH,LSFT(KC_3),KC_LGUI,KC_F4,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LGUI(KC_A),KC_NO,KC_TRANSPARENT,KC_TRANSPARENT,KC_PSCREEN,KC_RBRACKET,KC_TRANSPARENT),
